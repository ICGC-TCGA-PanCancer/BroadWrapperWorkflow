...
USER root
RUN apt-get update
RUN apt-get install -y python wget build-essential python-virtualenv python-dev git curl libffi-dev libssl-dev software-properties-common python-software-properties maven tabix
