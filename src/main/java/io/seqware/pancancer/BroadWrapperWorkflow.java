...
//            }
    ...
    private Job removeBlacklistedRepositories(String workflowId, Job previousJob) {
        ...
        removeBadReposJob.getCommand().addArgument("stat "+pathToScript+" && chmod a+x "+pathToScript + " && "+pathToScript+ " /workflows/gitroot/pcawg_tools/pcawg_data.tasks/workflow_"+workflowId);
